...
const Edit=()=>{
    ...
    return(
        ...
        Edit Employee No  <input type="text" name="rollno" value={mydata.rollno} onChange={handleInput}/>
        <br />
        ...
        <br />
        Enter Designation <input type="text" name="designation" value={mydata.designation} onChange={handleInput}/>
        <br />
        Edit Sallary <input type="text" name="fees" value={mydata.fees} onChange={handleInput}/>
        <br />

...
const studentSave = (req, res) => {
  const { rollno, name, city,designation, fees } = req.body;
...
const editDataSave=async(req,res)=>{
  const {_id, rollno,name, city,designation, fees}=req.body;
  const Data= await stuModels.findByIdAndUpdate(_id, {rollno,name,city,designation,fees});
